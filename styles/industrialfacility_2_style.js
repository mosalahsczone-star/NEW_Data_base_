...
var style_industrialfacility_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var labelFont = "22.1px \'Sakkal Majalla\', sans-serif";
    ...
    if (size == 1) { // If cluster has one feature
        ...
        if (feature.get("المنشأة الصناعية") !== null) {
            labelText = String(feature.get("المنشأة الصناعية"));
        }
    ...
    var style = [ new ol.style.Style({
        image: new ol.style.Icon({
                  ...
                  anchorYUnits: "pixels",
                  rotation: 0.0,
                  src: "styles/location-pin-svgrepo-com.svg"
            }),
